...
(function() {
	...
	var splitlayout = document.getElementById( 'splitlayout' ),
		bottomSide = splitlayout.querySelector( 'div.story > div.side-bottom' ),
		pageBottom = splitlayout.querySelector( 'div.page-bottom' ),
	...
	function init() {
		...
		bottomSide.querySelector( 'div.story-content' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.add( splitlayout, 'open-bottom' );
		} );
		...
		splitlayout.querySelector( 'a.back-story' ).addEventListener( eventtype, backToIntro );
	}

	function reset() {
		classie.remove( splitlayout, 'close-bottom' );
